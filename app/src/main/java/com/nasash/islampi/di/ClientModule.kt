package com.nasash.islampi.di

import android.content.Context
import com.nasash.islampi.data.network.rest.NetworkConnectionInterceptor
import com.nasash.islampi.data.repo.*
import com.nasash.islampi.util.*
...
object ClientModule {
    ...
    fun provideRetrofit(
        ...
        return Retrofit.Builder().client(okHttpClient)
            .baseUrl(com.nasash.islampi.constants.WebServiceConstant.API_BASE_URL)
